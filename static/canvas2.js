...
function selectImage() {
    ...
    img.onload = function () {
        ...
        clear();
        ctx.drawImage(img, (620 - new_width) / 2, (620 - new_height) / 2, new_width, new_height);
    }
}
...
$(function () {
    ...
    $("#colorBtn2").css('background-color', linecolor);
